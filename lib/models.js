...
var modelGetFormEmpty = function(modelIdentity) {
    ...
    _.forEach(attributes, function(attribute, name) {
        if(name !== 'createdAt' && name !== 'updatedAt') {
            ...
            if(attribute.hasOwnProperty("validations") && attribute.validations.isIn.length) {
                field.type = 'radios';
                field.options = {};
                _.forEach(attribute.validations.isIn, function(option) {
                    field.options[option] = "&nbsp;" + option;
                });
                field.defaultValue = attribute.validations.isIn[0];
            }
